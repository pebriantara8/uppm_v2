...
<head>
    ...
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
    <title>Aplikasi Pengajuan Dana Apresiasi PLPP Yogyakarta</title>
    <meta name="viewport"
    ...
    <!-- <script defer="defer" src="{{ asset('storage/template') }}/assets/scripts/lppm.js"></script> -->
    <script defer="defer" src="{{ asset('storage/template') }}/assets/scripts/toastr.js"></script>
    <script defer="defer" src="{{ asset('storage/template') }}/assets/scripts/scrollbar.js"></script>
    <script defer="defer" src="{{ asset('storage/template') }}/assets/scripts/fullcalendar.js"></script>
...
<body>
    <div class="app-container app-theme-white body-tabs-shadow fixed-sidebar fixed-header">
            ...
            <div class="app-header__content">
                <!-- <div class="app-header-left">
                    <div class="search-wrapper">
                        <div class="input-holder"><input class="search-input" placeholder="Type to search"> <button
                                class="search-icon"><span></span></button></div><button class="btn-close"></button>
                    </div>
                    <ul class="header-menu nav">
                        <li class="nav-item"><a href="javascript:void(0);" class="nav-link"><i
                                    class="nav-link-icon fa fa-database"></i> Statistics</a></li>
                        <li class="btn-group nav-item"><a href="javascript:void(0);" class="nav-link"><i
                                    class="nav-link-icon fa fa-edit"></i> Projects</a></li>
                        <li class="dropdown nav-item"><a href="javascript:void(0);" class="nav-link"><i
                                    class="nav-link-icon fa fa-cog"></i> Settings</a></li>
                    </ul>
                </div> -->
                        ...
                        <div class="widget-content p-0">
                            <div class="widget-content-wrapper">
                                <div class="widget-content-left">
                                    <div class="btn-group"><a data-bs-toggle="dropdown" aria-haspopup="true"
                                        ...
                                        <div tabindex="-1" role="menu" aria-hidden="true"
                                            ...
                                            <h6 tabindex="-1" class="dropdown-header">Header</h6><button type="button"
                                                tabindex="0" class="dropdown-item">Actions</button> -->
                                ...
                                <div class="widget-content-left ms-3 header-user-info">
                                    ...
                                    <div class="widget-subheading">Employee</div>
                                </div>
                                <!-- <div class="widget-content-right header-user-info ms-3"><button type="button"
                                        class="btn-shadow p-1 btn btn-primary btn-sm show-toastr-example"><i
                                            class="fa text-white fa-calendar pe-1 ps-1"></i></button>
                                </div> -->
                            </div>
                        </div>
                    </div>
        ...
        <div class="ui-theme-settings"><button type="button" id="TooltipDemo"
                class="btn-open-options btn btn-warning"><i class="fa fa-cog fa-w-16 fa-spin fa-2x"></i></button>
                ...
                <div class="scrollbar-container">
                    <div class="theme-settings__options-wrapper">
                                        ...
                                        <div class="widget-content-wrapper">
                                            <div class="widget-content-left me-3">
                                                <div class="switch has-switch switch-container-class"
                                                    ...
                                                    <div class="switch-animate switch-on"><input type="checkbox"
                                                            checked="checked" data-toggle="toggle"
                                                            data-onstyle="success"></div>
                                                </div>
                                            </div>
                                            <div class="widget-content-left">
                                        ...
                                        <div class="widget-content-wrapper">
                                            <div class="widget-content-left me-3">
                                                <div class="switch has-switch switch-container-class"
                                                    ...
                                                    <div class="switch-animate switch-off"><input type="checkbox"
                                                            data-toggle="toggle" data-onstyle="success"></div>
                                                </div>
                                            </div>
                                            <div class="widget-content-left">
                        ...
                        <h3 class="themeoptions-heading">
                            <div>Header Options</div><button type="button"
                        ...
                        <h3 class="themeoptions-heading">
                            <div>Sidebar Options</div><button type="button"
                        ...
                        <h3 class="themeoptions-heading">
                            <div>Main Content Options</div><button type="button"
                        ...
                        <div class="p-3">
                            <ul class="list-group">
                                <li class="list-group-item">
                                    ...
                                    <div class="theme-settings-swatches">
                                        <div role="group" class="mt-2 btn-group"><button type="button"
                                                class="btn-wide btn-shadow btn-primary btn btn-secondary switch-theme-class"
                                                data-class="body-tabs-line">Line</button> <button type="button"
                                                class="btn-wide btn-shadow btn-primary active btn btn-secondary switch-theme-class"
                                                data-class="body-tabs-shadow">Shadow</button></div>
                                    </div>
                                </li>
                            </ul>
                        </div>
                            ...
                            <div class="app-footer-right">
                                <ul class="nav">
                                    ...
                                    <li class="nav-item"><a href="javascript:void(0);" class="nav-link">
                                            <div class="badge bg-success me-1 ms-0"></div>Sistem Pengajuan Dana
                                            Apresiasi
                                            PLPP v.1
                                        </a></li>
                                </ul>
